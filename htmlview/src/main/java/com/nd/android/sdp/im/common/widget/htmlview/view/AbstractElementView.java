...
abstract class AbstractElementView extends ViewGroup implements HasMeasuredPosition {
   ...
   */
  protected AbstractElementView(Context context) {
    super(context);
    defaultInit();
  }
  ...
  public AbstractElementView(Context context, AttributeSet attrs) {
    super(context, attrs);
    defaultInit();
  }

  public AbstractElementView(Context context, AttributeSet attrs, int defStyleAttr) {
